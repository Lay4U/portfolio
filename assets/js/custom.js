...
$(window).scroll(function() {
    var wScroll = $(this).scrollTop();
    console.log('스크롤' + wScroll);
    console.log($('.sec2 .strapline').offset().top - $(window).height() / 1.5);
    console.log('**' + $('.sec3 .cont_right .s3_img'));
    //section2 about
    if (
        wScroll >=
        $('.sec2 .strapline').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec2 .skill-wrap').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_img').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .revealer').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_text').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_img').eq(1).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .revealer').eq(1).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_text').eq(1).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_img').eq(2).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .revealer').eq(2).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_text').eq(2).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_img').eq(3).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .revealer').eq(3).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_left .s3_text').eq(3).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .s3_img').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .revealer').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .s3_text').offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .s3_img').eq(1).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .revealer').eq(1).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .s3_text').eq(1).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .s3_img').eq(2).offset().top - $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .revealer').eq(2).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    if (
        wScroll >=
        $('.sec3 .cont_right .s3_text').eq(2).offset().top -
        $(window).height() / 1.5
    ) {
    ...
    // if (
    //     wScroll >=
    //     $('.sec3 .cont_left .s3_img').eq(4).offset().top - $(window).height() / 1.5
    // ) {
    //     $('.sec3 .cont_left .s3_img').eq(4).addClass('show');
    // } else {
    //     $('.sec3 .cont_left .s3_img').eq(4).removeClass('show');
    // }
    // if (
    //     wScroll >=
    //     $('.sec3 .cont_left .revealer').eq(4).offset().top -
    //     $(window).height() / 1.5
    // ) {
    //     $('.sec3 .cont_left .revealer').eq(4).addClass('show');
    // } else {
    //     $('.sec3 .cont_left .revealer').eq(4).removeClass('show');
    // }
    // if (
    //     wScroll >=
    //     $('.sec3 .cont_left .s3_text').eq(4).offset().top - $(window).height() / 1.5
    // ) {
    //     $('.sec3 .cont_left .s3_text').eq(4).addClass('show');
    // } else {
    //     $('.sec3 .cont_left .s3_text').eq(4).removeClass('show');
    // }
    // if (
    //     wScroll >=
    //     $('.sec3 .cont_left .s3_img').eq(5).offset().top - $(window).height() / 1.5
    // ) {
    //     $('.sec3 .cont_left .s3_img').eq(5).addClass('show');
    // } else {
    //     $('.sec3 .cont_left .s3_img').eq(5).removeClass('show');
    // }
    // if (
    //     wScroll >=
    //     $('.sec3 .cont_left .revealer').eq(5).offset().top -
    //     $(window).height() / 1.5
    // ) {
    //     $('.sec3 .cont_left .revealer').eq(5).addClass('show');
    // } else {
    //     $('.sec3 .cont_left .revealer').eq(5).removeClass('show');
    // }
    // if (
    //     wScroll >=
    //     $('.sec3 .cont_left .s3_text').eq(5).offset().top - $(window).height() / 1.5
    // ) {
    //     $('.sec3 .cont_left .s3_text').eq(5).addClass('show');
    // } else {
    //     $('.sec3 .cont_left .s3_text').eq(5).removeClass('show');
    // }
    ...
    if (
        wScroll >=
        $('.sec5 .namecard .sp1').offset().top - $(window).height() / 1
    ) {
    ...
    if (
        wScroll >=
        $('.sec5 .namecard .card').offset().top - $(window).height() / 1
    ) {
    ...
    if (
        wScroll >=
        $('.sec5 .namecard .sp2').offset().top - $(window).height() / 1
    ) {
